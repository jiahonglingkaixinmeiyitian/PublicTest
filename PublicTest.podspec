...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "jiahongling"
  # s.authors            = { "jiahongling" => "m15116996950@163.com" }
  # s.social_media_url   = "http://twitter.com/jiahongling"
  ...
  s.source       = { :git => "https://github.com/jiahonglingkaixinmeiyitian/PublicTest.git", :tag => "0.0.1" }
